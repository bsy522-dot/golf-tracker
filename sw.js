      ...
      fetch(e.request).then(function(resp) {
        if (resp.ok) {
          return resp.text().then(function(html) {
            if (html.indexOf('v29_patch.js') === -1 && html.indexOf('</body>') !== -1) {
              html = html.replace('</body>', '<script src="v29_patch.js"><\/script>\n</body>');
            }
            if (html.indexOf('v28_patch.js') === -1 && html.indexOf('</body>') !== -1) {
              html = html.replace('</body>', '<script src="v28_patch.js"><\/script>\n</body>');
            }
            if (html.indexOf('v27_patch.js') === -1 && html.indexOf('</body>') !== -1) {
              html = html.replace('</body>', '<script src="v27_patch.js"><\/script>\n</body>');
            }
            if (html.indexOf('v26_patch.js') === -1 && html.indexOf('</body>') !== -1) {
              html = html.replace('</body>', '<script src="v26_patch.js"><\/script>\n</body>');
            }
            if (html.indexOf('v25_patch.js') === -1 && html.indexOf('</body>') !== -1) {
              html = html.replace('</body>', '<script src="v25_patch.js"><\/script>\n</body>');
            }
